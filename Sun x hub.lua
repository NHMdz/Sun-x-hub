...
local Library = Update:Window("Sun Hub","",Enum.KeyCode.RightControl);
...
H:AddLabel("Sun Hub Discord")
H:AddLabel("https://discord.com/invite/K8yGzuTH5r")
H:AddLabel("Discord: t_sun")
 

H:AddButton("Youtube Ended",function()
setclipboard("https://youtube.com/@ended-ht9hm?si=-LDyOPLFhKzM1qEO")
